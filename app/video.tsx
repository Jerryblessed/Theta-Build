...
export default function Video() {
    ...
    return (
        <div className={styles.alignment}>
            <h1 style={{ textDecoration: 'bold', fontSize: '30px' }}>Construct something awesome</h1>
            ...
            >
                ...
                <h3 style={{ textDecoration: 'bold', }}>Get project/jobs</h3>
            ...
            <div className="relative w-full h-[calc(100vh-100px)]"> {/* Adjusted for full viewport height */}
                <iframe
                    src="https://jerrychan7.github.io/WebMC/"
                    width="100%"
                    height="100%"
                    frameBorder="0"
            ...
            <div
                ...
                onDragOver={handleDragOver}
                onDrop={handleDrop}
                onClick={() => window.open('https://www.thetaedgecloud.com/dashboard/video/videos', '_blank')}
            >
                <p>Use alternative video upload link...</p>
            </div>
